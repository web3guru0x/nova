...
class MotifPool(torch.nn.Module):
    ...
    def forward(self, x, x_clique, atom2clique_index, clique_batch, clique_edge_index):
        ...
        # Use CUDA stream for faster computation
        with torch.cuda.stream(torch.cuda.Stream()):
            ...
            # Process in parallel using multiple MLPs
            for i, mlp in enumerate(self.score_proj):
                score_list.append(mlp(score_clique[:, i]))
            ...
            # Use CUDA for more efficient pooling
